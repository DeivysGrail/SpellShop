...
import {Link} from "react-router-dom"; // import du composant Link qui permet de mener les liens vers des pages

// import des logos des réseaux sociaux
...
/*      Représente le footer, avec les cgu, informations légales, réseaux, ect..

        Contient aussi la rubrique 'Qui sommes-nous' qui amène à la page /créateurs et au composant 'Createurs'
 */
export default function HomeFooter() {

    return <div className={"footer-div"}>
        <h1>Subscribe & get a random spell</h1>
        <div className={"tous-les-ul-du-footer"}> {/* Div de tous les ul présents dans le footer. C'est la div root */}
            <div className="first-footer-ul">
                <div className="first-ul-title ul-title">
                    <h4>Infos</h4>
                </div>
                <ul>                {/* Partie avec les infos qui n'intéressent personne */  }
            ...
            <ul className={"ul-reseaux"}>      {/* Partie avec les réseaux de la page */}
            ...
            <div className="last-footer-ul">
                ...
                <div className="ul-aide">
                    <ul>                        {/* Partie avec les FAQ, SAV et contact */}
